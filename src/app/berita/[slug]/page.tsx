        ...
        <div className="container-main py-8 overflow-hidden">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
            ...
            <article className="lg:col-span-2">
              ...
              {/* AI disclosure — transparansi untuk artikel yang disusun dengan bantuan AI */}
              {article.isAutoGenerated && (
                <div className="mt-6 flex items-start gap-2.5 rounded-[12px] border border-border bg-surface-secondary px-4 py-3">
                  <Bot size={16} className="mt-0.5 shrink-0 text-txt-muted" />
                  <p className="text-xs leading-relaxed text-txt-muted">
                    Artikel ini disusun dengan bantuan teknologi kecerdasan buatan (AI) dan telah
                    ditinjau serta diverifikasi oleh redaksi{editorName ? <> ({editorName})</> : null}{" "}
                    sebelum dipublikasikan. Selengkapnya:{" "}
                    <Link href="/kebijakan-ai" className="text-goto-green hover:underline">
