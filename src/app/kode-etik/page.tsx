...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://jurnalishukumbandung.com/kode-etik" },
};
      ...
      <div className="container-main py-12">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 font-serif text-[17px] leading-relaxed text-txt-secondary">
            <p>
              Jurnalis Hukum Bandung menganut dan mematuhi <strong className="text-txt-primary">Kode Etik Jurnalistik</strong> yang
